package com.globallogic.javaacademy.functional.step5.optional;

import com.globallogic.javaacademy.functional.step5.optional.model.Concert;
import com.globallogic.javaacademy.functional.step5.optional.model.MusicBand;
import com.globallogic.javaacademy.functional.step5.optional.model.MusicStar;
...
//                .flatMap(MusicStar::getAddress)
    ...
    @Test
    public void filter() {
        final Concert concert = new Concert("Woodstock", new MusicBand("Kombi", new MusicStar("Jan", "Nowak", new Address("Kraków", "Długa"))));
        Optional.of(concert)
                .map(Concert::getMusicBand)
